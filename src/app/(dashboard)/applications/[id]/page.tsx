import { db } from "@/db";
import { loanApplications, customers, loanProducts, collaterals, applicationStatusHistory } from "@/db/schema";
...
export default async function ApplicationDetailPage({ params }: ApplicationDetailPageProps) {
  ...
  const [appCollaterals, statusHistory] = await Promise.all([
